...
export interface _SERVICE {
  ...
  'createBooking' : ActorMethod<[Creation__3], Public__3>,
  'createCheckoutSession' : ActorMethod<
    [Array<ShoppingItem>, string, string],
    string
  >,
  'createPayment' : ActorMethod<[Creation__2], Public__2>,
  ...
  'getAllBookings' : ActorMethod<[], Array<Public__3>>,
  'getAllPayments' : ActorMethod<[], Array<Public__2>>,
  'getAllSitters' : ActorMethod<[], Array<Public>>,
  'getBookingsByClientEmail' : ActorMethod<[string], Array<Public__3>>,
  'getBookingsBySitter' : ActorMethod<[Id], Array<Public__3>>,
  'getCallerUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getMessages' : ActorMethod<[Id], Array<Message>>,
  'getPayment' : ActorMethod<[Id], [] | [Public__2]>,
  'getServiceLogsByBooking' : ActorMethod<[Id], Array<Public__1>>,
